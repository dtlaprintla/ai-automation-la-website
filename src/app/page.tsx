            ...
            <div>
              ...
              <div className="bg-[#111827] rounded-lg p-6 border border-gray-800">
                <div className="flex items-center gap-4 mb-4">
                  ...
                  <div>
                    ...
                    <p className="text-white">
                      <span className="font-bold">Local Restaurant Chain</span> saves $50K
                      <br />
                ...
                <p className="text-gray-500 text-sm mt-4">
                  We needed a solution that could integrate
                  <br />
                  with our existing systems — AI Automation
                  <br />
                  LA's flexible approach made this
                  <br />
                  seamless.
                </p>
                ...
                <div className="flex items-center gap-3 mt-4">
                  ...
                  <div>
                    <p className="text-white text-sm font-medium">Sarah Martinez</p>
                    <p className="text-gray-500 text-xs">CTO, TASTE OF LA</p>
                  </div>
                </div>
              </div>
            </div>
      ...
      <section className="py-20 bg-[#0E0E13] border-t border-gray-800">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-gray-400 text-lg mb-8">
            Join hundreds of LA businesses saving time with AI automation.
          </p>
